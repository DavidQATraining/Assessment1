	...
	# In case it is not clear, the Question appears first, then examples,
	# then any hints and finally the function that you need to complete appears underneath:
	...
	# You are allowed access to the internet for this assessment, or you could
	# use the DOCUMENTATION that comes bundled with your Python installation.
	# You should already be comfortable accessing this documentation, but to summarise:
